...
```json
{
  ...
  "Statement": [
    ...
    {
      "Effect": "Deny",
      "Action": ["s3:DeleteObjectVersion", "s3:BypassGovernanceRetention", "s3:PutObjectLegalHold"],
      "Resource": "arn:aws:s3:::${BUCKET}/*"
    }
  ]
}
