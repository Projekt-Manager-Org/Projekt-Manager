...
Four services in `docker-compose.yml`; `storage` and `storage-init` come from the `docker-compose.minio.yml` overlay, dev/CI only — deployments use B2 ([ADR-0022](docs/adr/0022-binary-storage-b2-compliance-object-lock.md)):
...
| `storage`      | `ghcr.io/projekt-manager-org/minio` (GHCR mirror)           | S3-compatible object storage                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `storage-init` | `ghcr.io/projekt-manager-org/mc` (GHCR mirror, one-shot)    | Creates the default bucket on first start, then exits                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
